...
class PaintingsControllerTest < ActionController::TestCase
  ...
  test "should create painting" do
    assert_difference('Painting.count') do
      post :create, painting: { name: @painting.name, price: @painting.price, quantity_in_stock: @painting.quantity_in_stock }
    end
  ...
  test "should update painting" do
    patch :update, id: @painting, painting: { name: @painting.name, price: @painting.price, quantity_in_stock: @painting.quantity_in_stock }
    assert_redirected_to painting_path(assigns(:painting))
  end
